...
buildit() {
    ...
    REFLEX_ARGS="-DREflex_ROOT=/opt-linux-x86_64/reflex"
    # CMAKE_DBG_ARGS="--trace-expand"

    cmake $CMAKE_DBG_ARGS $CLANG_ARGS $REFLEX_ARGS -DCMAKE_INSTALL_PREFIX=$rootdir/$dist_dir ..
    # cmake $CMAKE_DBG_ARGS $CLANG_ARGS $REFLEX_ARGS -DCMAKE_INSTALL_PREFIX=$rootdir/$dist_dir -DDEBUG=ON ..
